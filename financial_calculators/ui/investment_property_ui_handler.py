...
class InvestmentPropertyUIHandler:
    ...
    def get_interest_rates(self) -> list[tuple[float, int]]:
        """
        Get the interest rates for different periods from the user.
        
        Returns:
            list[tuple[float, int]]: List of (interest_rate, num_years) tuples
        """
        interest_rates = []
    ...
    def get_management_inflation(self) -> float:
        """
        Get the management inflation from the user.
        
        Returns:
            float: Management inflation
        """
        return float(st.number_input(
            ...
            value=2.0,
            step=0.1,
            help="Annual percentage increase in management costs",
            key="management_inflation"
        ))

    def get_hoa_fees_inflation(self) -> float:
        """
        Get the HOA fees inflation from the user.
        
        Returns:
            float: HOA fees inflation
        """
        return float(st.number_input(
            "HOA Fees Inflation (%)",
            min_value=0.0,
            value=2.0,
            step=0.1,
            help="Annual percentage increase in HOA fees",
            key="hoa_fees_inflation"
        ))
    ...
    def get_property_tax_inflation(self) -> float: 
        """
        Get the property tax inflation from the user.
        
        Returns:
            float: Property tax inflation
        """
        return float(st.number_input(
            ...
            key="property_tax_inflation"
        ))

    def get_insurance_inflation(self) -> float: 
        """
        Get the insurance inflation from the user.
        
        Returns:
            float: Insurance inflation
        """
        return float(st.number_input(
            ...
            value=2.0,
            step=0.1,
            help="Expected annual increase in property insurance",
            key="insurance_inflation"
        ))

    def get_utilities_inflation(self) -> float: 
        """
        Get the utilities inflation from the user.
        
        Returns:
            float: Utilities inflation
        """
        return float(st.number_input(
            ...
            value=2.0,
            step=0.1,
            help="Expected annual increase in utilities",
            key="utilities_inflation"
        ))
